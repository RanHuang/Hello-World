...
Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur buhrf, fur fvgf nebhaq gur buhfr.
The Gothon stops, tries not to laugh, the busts out laughing and can't move.
While he's laughing you run up and shoot him suqare in the head putting him down, then jump through the Weapon Armory door.
...
They haven't pulled their weapons out yet, as they see the active bomb under your arm and don't want to see it off.
""")

escape_pod = Room("Escape Pod",
"""
You point your blaster at the bomb uner your arm and the Gothons put their hands up and start to sweat. 
You inch backward to the door, open it, and then cafully place the bomb on the floor, pointing your blaster at it. 
You then jump back through the door, punch the close button and blast the lock so the Gothons can't get out. 
Now that the bomb is placed you run to the escape pod ot get off this tin can.

You rush through the ship desperately trying to make it to the escape pod before the whole sheep explodes. 
It seems like hardly and Gothons are on the ship, so your run is clear of interference. 
...
"""
You jumb into pod 2 and hit the eject button. The pod easily slides out into space heading to the planet below. 
As it flies to the planet, you look back and see tyour ship implode the explode like a bright star, taking out the Gothon ship at the same tiem. You won!
""")

the_end_loser = Room("The End",
"""
You jumb into a random  pod and hit the eject button.
The pod escapes out into the void of space, then implodes as the hull reptures, crushing your body int the jam jelly.
""")
